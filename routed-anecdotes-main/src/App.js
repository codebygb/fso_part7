...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.setNotification(`Created new note '${content.value}'`);
    navigate("/");
  };
  ...
  return (
    <div>
      ...
      <Routes>
        <Route
          path="/anecdotes/:id"
          element={<ViewAnecdote anecdote={anecdote}></ViewAnecdote>}
        />
        <Route
          path="/anecdotes"
          element={
        ...
        <Route
          path="/create"
          element={<CreateNew addNew={addNew} setNotification={notify} />}
        />
        <Route
          path="/"
          element={
